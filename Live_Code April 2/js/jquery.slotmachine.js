...
class SlotMachine {
     ...
     */
    get random () {      
    	var lengthdata = Math.floor(Math.random() * this.$tiles.length);  
        if(list.includes(lengthdata)){
                    var lengthdatanew = Math.floor(Math.random() * this.$tiles.length);
                    list.push(lengthdatanew);
                    return lengthdatanew;
        }else{
                  list.push(lengthdata); 
                  return lengthdata;
        }
    }
